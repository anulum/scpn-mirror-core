...
# SCPN Mirror Core — portable diagnostic-plan envelope tests
...
FIXTURE_SHA256 = "2586afbaf9129f5dcedb955c7dc768b9bfaa740212c3ca21f3d337e3e5668184"
...
def test_constants_are_the_published_contract() -> None:
    ...
    assert PROJECT == "SCPN-MIRROR-CORE"
    assert NON_CLAIMS == (
