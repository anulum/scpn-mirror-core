...
The project boundary — the assignment of `gas_dynamic_mirror` and
`simple_magnetic_mirror` and
`tandem_mirror` to this repository, and the exclusions listed in the
